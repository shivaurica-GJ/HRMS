                ...
                <tr key={employee._id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <Link to={`/admin/reports/manage/${employee._id}`} className="text-sm font-medium text-blue-600 hover:text-blue-800">
                          {employee.fullName}
                        </Link>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <Link to={`/admin/reports/manage/${employee._id}`} className="text-blue-600 hover:text-blue-900">
                      View Details
                    </Link>
                  </td>
                </tr>
